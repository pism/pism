// Copyright (C) 2007-2014 Ed Bueler and Nathan Shemonski and Constantine Khroulev
//
...
PA_EISMINT_Greenland::PA_EISMINT_Greenland(IceGrid &g, const PISMConfig &conf)
