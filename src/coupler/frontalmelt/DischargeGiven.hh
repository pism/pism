// Copyright (C) 2018, 2021, 2022, 2023 Andy Aschwanden and Constantine Khroulev
//
...
#ifndef PISM_FRONTAL_MELT_DISCHARGE_GIVEN_HH
#define PISM_FRONTAL_MELT_DISCHARGE_GIVEN_HH
...
#endif /* PISM_FRONTAL_MELT_DISCHARGE_GIVEN_HH */
