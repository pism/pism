/* Copyright (C) 2018, 2025 PISM Authors
 *
...
#ifndef PISM_SEA_LEVEL_INITIALIZATION_HH
#define PISM_SEA_LEVEL_INITIALIZATION_HH
...
#endif /* PISM_SEA_LEVEL_INITIALIZATION_HH */
