...
void PO_delta_SMB::add_vars_to_output(string keyword, map<string,NCSpatialVariable> &result) {
...
PetscErrorCode PO_delta_SMB::write_variables(set<string> vars, string file) {
  PetscErrorCode ierr;
  IceModelVec2S tmp;
