...
const int PicoOld::imask_inner        = 2;
const int PicoOld::imask_outer        = 0;
const int PicoOld::imask_exclude      = 1;
const int PicoOld::imask_unidentified = -1;




// To be used solely in round_basins()
double PicoOld::most_frequent_element(const std::vector<double> &v)
...
void PicoOld::identifyMASK(IceModelVec2S &inputmask, std::string masktype) {
...
void PicoOld::identify_shelf_mask() {
...
void PicoOld::compute_distances() {
...
void PicoOld::identify_ocean_box_mask(const Constants &cc) {
