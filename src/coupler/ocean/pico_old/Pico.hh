...
#ifndef _POPICO_OLD_H_
#define _POPICO_OLD_H_
...
//!
class PicoOld : public PGivenClimate<CompleteOceanModel,CompleteOceanModel> {
public:
  PicoOld(IceGrid::ConstPtr g);
  virtual ~PicoOld();
