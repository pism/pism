...
void Elevation::init_impl() {
  ...
  // options
  {
    ...
    {
      // set defaults:
      m_T_min   = m_grid.convert(-5.0, "Celsius", "Kelvin");
      m_T_max   = m_grid.convert(0.0, "Celsius", "Kelvin");
      m_z_T_min = 1325.0;
      m_z_T_max = 1350.0;
      ...
      if (IST.is_set()) {
        ...
        m_T_min   = m_grid.convert(IST[0], "Celsius", "Kelvin");
        m_T_max   = m_grid.convert(IST[1], "Celsius", "Kelvin");
        m_z_T_min = IST[2];
        m_z_T_max = IST[3];
      }
    }
    ...
    {
      // set defaults:
      m_M_min   = m_grid.convert(-3.0, "m year-1", "m s-1");
      m_M_max   = m_grid.convert(4.0, "m year-1", "m s-1");
      m_z_M_min = 1100.0;
      m_z_ELA   = 1450.0;
      m_z_M_max = 1700.0;
      ...
      if (CMB.is_set()) {
        ...
        m_M_min   = m_grid.convert(CMB[0], "m year-1", "m s-1");
        m_M_max   = m_grid.convert(CMB[1], "m year-1", "m s-1");
        m_z_M_min = CMB[2];
        m_z_ELA   = CMB[3];
        m_z_M_max = CMB[4];
      }
    ...
    // limits of the climatic mass balance
    {
      ...
      if (m_limits.is_set()) {
        ...
        m_M_limit_min = m_grid.convert(m_limits[0], "m year-1", "m s-1");
        m_M_limit_max = m_grid.convert(m_limits[1], "m year-1", "m s-1");
      } else {
  ...
  verbPrintf(3, m_grid.com,
             ...
             m_grid.convert(m_M_limit_min, "m s-1", "m year-1"),
             m_z_M_min, m_M_min, m_z_M_max,
             m_grid.convert(m_M_max, "m s-1", "m year-1"),
             m_z_M_max,
  ...
  verbPrintf(2, m_grid.com,
             ...
             m_grid.convert(m_M_limit_min, "m s-1", "m year-1"), m_z_M_min,
             m_grid.convert(-m_M_min, "m s-1", "m year-1")/(m_z_ELA - m_z_M_min), m_z_ELA, m_z_M_min, m_z_ELA,
             m_grid.convert(m_M_max, "m s-1", "m year-1")/(m_z_M_max - m_z_ELA), m_z_ELA, m_z_ELA, m_z_M_max,
