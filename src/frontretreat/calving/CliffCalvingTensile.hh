...
#ifndef CLIFFCALVINGTENSILE_H
#define CLIFFCALVINGTENSILE_H
...
class CliffCalvingTensile : public Component {
public:
  CliffCalvingTensile(std::shared_ptr<const Grid> grid);
  virtual ~CliffCalvingTensile() = default;
