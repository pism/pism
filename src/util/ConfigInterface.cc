...
void set_config_from_options(Config &config) {
...

  {
    std::vector<double> defaults = {
      ...
      config.get_double("basal_yield_stress.mohr_coulomb.iterative_phi.phi_min"),
      config.get_double("basal_yield_stress.mohr_coulomb.iterative_phi.phi_minup"),
      config.get_double("basal_yield_stress.mohr_coulomb.iterative_phi.phi_max"),
      config.get_double("basal_yield_stress.mohr_coulomb.iterative_phi.dphi"),
      config.get_double("basal_yield_stress.mohr_coulomb.iterative_phi.dt"),
      config.get_double("basal_yield_stress.mohr_coulomb.iterative_phi.h_inv"),
      config.get_double("basal_yield_stress.mohr_coulomb.iterative_phi.topg_min"),
      config.get_double("basal_yield_stress.mohr_coulomb.iterative_phi.topg_max"),
      config.get_double("basal_yield_stress.mohr_coulomb.iterative_phi.dh_conv")
    };
    ...
    if (iterative_phi.is_set()) {
      ...
      config.set_boolean("basal_yield_stress.mohr_coulomb.iterative_phi.enabled", true);

      config.set_double("basal_yield_stress.mohr_coulomb.iterative_phi.phi_min", iterative_phi[0]);
      config.set_double("basal_yield_stress.mohr_coulomb.iterative_phi.phi_minup", iterative_phi[1]);
      config.set_double("basal_yield_stress.mohr_coulomb.iterative_phi.phi_max", iterative_phi[2]);
      config.set_double("basal_yield_stress.mohr_coulomb.iterative_phi.dphi", iterative_phi[3]);
      config.set_double("basal_yield_stress.mohr_coulomb.iterative_phi.dt", iterative_phi[4]);
      config.set_double("basal_yield_stress.mohr_coulomb.iterative_phi.h_inv", iterative_phi[5]);
      config.set_double("basal_yield_stress.mohr_coulomb.iterative_phi.topg_min", iterative_phi[6]);
      config.set_double("basal_yield_stress.mohr_coulomb.iterative_phi.topg_max", iterative_phi[7]);
      config.set_double("basal_yield_stress.mohr_coulomb.iterative_phi.dh_conv", iterative_phi[8]);
