...
protected:
  Vector(std::shared_ptr<const Grid> grid, const std::string &name, unsigned int stencil_width);
};
...
protected:
  Vector1(std::shared_ptr<const Grid> grid, const std::string &name, unsigned int stencil_width);
};
