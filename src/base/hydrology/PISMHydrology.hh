...
Unlike the general case PISMHydrology, in this model we have the fields which
allow us to compute the wall melt generated by dissipating the heat on the
