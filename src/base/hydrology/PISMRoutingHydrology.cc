...
Routing_bwatvel::Routing_bwatvel(Routing *m)
  ...
  // set metadata:
  m_dof = 2;
  m_vars.push_back(SpatialVariableMetadata(m_grid.config.unit_system(), "bwatvel[0]"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.config.unit_system(), "bwatvel[1]"));
