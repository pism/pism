...
Routing_bwatvel::Routing_bwatvel(Routing *m)
  ...
  // set metadata:
  m_dof = 2;
  m_vars.push_back(NCSpatialVariable(m_grid.config.unit_system(), "bwatvel[0]", m_grid));
  m_vars.push_back(NCSpatialVariable(m_grid.config.unit_system(), "bwatvel[1]", m_grid));
