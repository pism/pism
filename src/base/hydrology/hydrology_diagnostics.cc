...
Hydrology_bwat::Hydrology_bwat(Hydrology *m)
  : Diag<Hydrology>(m) {
  m_vars.push_back(SpatialVariableMetadata(m_grid.config.unit_system(), "bwat", m_grid));
...
Hydrology_bwp::Hydrology_bwp(Hydrology *m)
  : Diag<Hydrology>(m) {
  m_vars.push_back(SpatialVariableMetadata(m_grid.config.unit_system(), "bwp", m_grid));
...
Hydrology_bwprel::Hydrology_bwprel(Hydrology *m)
  : Diag<Hydrology>(m) {
  m_vars.push_back(SpatialVariableMetadata(m_grid.config.unit_system(), "bwprel", m_grid));
...
Hydrology_effbwp::Hydrology_effbwp(Hydrology *m)
  : Diag<Hydrology>(m) {
  m_vars.push_back(SpatialVariableMetadata(m_grid.config.unit_system(), "effbwp", m_grid));
...
Hydrology_hydrobmelt::Hydrology_hydrobmelt(Hydrology *m)
  : Diag<Hydrology>(m) {
  m_vars.push_back(SpatialVariableMetadata(m_grid.config.unit_system(), "hydrobmelt", m_grid));
...
Hydrology_hydroinput::Hydrology_hydroinput(Hydrology *m)
  : Diag<Hydrology>(m) {
  m_vars.push_back(SpatialVariableMetadata(m_grid.config.unit_system(), "hydroinput", m_grid));
...
Hydrology_wallmelt::Hydrology_wallmelt(Hydrology *m)
  : Diag<Hydrology>(m) {
  m_vars.push_back(SpatialVariableMetadata(m_grid.config.unit_system(), "wallmelt", m_grid));
