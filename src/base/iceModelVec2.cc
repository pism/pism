...
PetscErrorCode IceModelVec2Mask::fill_where_grounded(IceModelVec2S &var, const PetscScalar fillval) {
  PetscErrorCode ierr;
...
PetscErrorCode IceModelVec2Mask::fill_where_floating(IceModelVec2S &var, const PetscScalar fillval) {
  PetscErrorCode ierr;
