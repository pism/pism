...
PSB_velbar::PSB_velbar(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "ubar"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "vbar"));
...
PSB_velbar_mag::PSB_velbar_mag(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "velbar_mag"));
...
IceModelVec::Ptr PSB_velbar_mag::compute() {
  ...
  result->mask_by(*thickness, m_grid.ctx()->config()->get_double("fill_value", "m/year", "m/s"));
...
PSB_flux::PSB_flux(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "uflux"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "vflux"));
...
PSB_flux_mag::PSB_flux_mag(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "flux_mag"));

  set_attrs("magnitude of vertically-integrated horizontal flux of ice", "",
            "m2 s-1", "m2 year-1", 0);
  m_vars[0].set_double("_FillValue", m_grid.ctx()->config()->get_double("fill_value", "m2/year", "m2/s"));
  m_vars[0].set_double("valid_min", 0.0);
}
...
PSB_velbase_mag::PSB_velbase_mag(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "velbase_mag"));
...
PSB_velsurf_mag::PSB_velsurf_mag(StressBalance *m)
  : Diag<StressBalance>(m) {
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "velsurf_mag"));
...
PSB_velsurf::PSB_velsurf(StressBalance *m)
  ...
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "uvelsurf"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "vvelsurf"));
...
IceModelVec::Ptr PSB_velsurf::compute() {
  double fill_value = m_grid.ctx()->config()->get_double("fill_value", "m/year", "m/s");
...
PSB_wvel::PSB_wvel(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "wvel",
                                           m_grid.z()));
...
PSB_wvelsurf::PSB_wvelsurf(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "wvelsurf"));
...
PSB_wvelbase::PSB_wvelbase(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "wvelbase"));
...
PSB_velbase::PSB_velbase(StressBalance *m)
  ...
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "uvelbase"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "vvelbase"));
...
PSB_bfrict::PSB_bfrict(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "bfrict"));
...
PSB_uvel::PSB_uvel(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "uvel", m_grid.z()));
...
PSB_vvel::PSB_vvel(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "vvel", m_grid.z()));
...
PSB_wvel_rel::PSB_wvel_rel(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "wvel_rel", m_grid.z()));
...
PSB_strainheat::PSB_strainheat(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "strainheat", m_grid.z()));
...
PSB_strain_rates::PSB_strain_rates(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "eigen1"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "eigen2"));
...
PSB_deviatoric_stresses::PSB_deviatoric_stresses(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "sigma_xx"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "sigma_yy"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "sigma_xy"));
...
PSB_pressure::PSB_pressure(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "pressure",
                                           m_grid.z()));
...
PSB_tauxz::PSB_tauxz(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "tauxz", m_grid.z()));
...
PSB_tauyz::PSB_tauyz(StressBalance *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "tauyz",
                                           m_grid.z()));
