...
SIAFD_schoofs_theta::SIAFD_schoofs_theta(SIAFD *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.config()->unit_system(), "schoofs_theta"));
...
SIAFD_topgsmooth::SIAFD_topgsmooth(SIAFD *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.config()->unit_system(), "topgsmooth"));
...
SIAFD_thksmooth::SIAFD_thksmooth(SIAFD *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.config()->unit_system(), "thksmooth"));
...
SIAFD_diffusivity::SIAFD_diffusivity(SIAFD *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.config()->unit_system(), "diffusivity"));
...
SIAFD_diffusivity_staggered::SIAFD_diffusivity_staggered(SIAFD *m)
  ...
  m_vars.push_back(SpatialVariableMetadata(m_grid.config()->unit_system(), "diffusivity_i"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.config()->unit_system(), "diffusivity_j"));
...
SIAFD_h_x::SIAFD_h_x(SIAFD *m)
  ...
  m_vars.push_back(SpatialVariableMetadata(m_grid.config()->unit_system(), "h_x_i"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.config()->unit_system(), "h_x_j"));
...
SIAFD_h_y::SIAFD_h_y(SIAFD *m)
  ...
  m_vars.push_back(SpatialVariableMetadata(m_grid.config()->unit_system(), "h_y_i"));
  m_vars.push_back(SpatialVariableMetadata(m_grid.config()->unit_system(), "h_y_j"));
