...
void IceModel::createVecs() {
  ...
  if (m_config->get_string("calving_methods").find("eigen_calving") != std::string::npos or m_config->get_string("calving_methods").find("stress_calving") != std::string::npos or
