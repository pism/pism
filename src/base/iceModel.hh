...
/*! \mainpage 
 *
 * This source browser shows the C++ class structure of PISM.  It (verbosely!)
 ...
 *
 * See the PISM Reference Manual (pism/doc/doxy/latex/refman.pdf)
 ...
 * about the files as files).
 *
 * Also see the PISM User's Manual (pism/doc/manual.pdf) for help with installing
 * and using PISM. 
 *
 */
/// @endcond
