...
/*! \mainpage 
 *
 * This source browser shows the C++ class structure of PISM.  It (rather verbosely)
 ...
 *
 * See the PISM User's Manual (http://www.dms.uaf.edu/~bueler/manual.pdf or pism/doc/manual.pdf)
 * for help with installing and using PISM.
 *
 * See the PISM Reference Manual (pism/doc/refman.pdf)
