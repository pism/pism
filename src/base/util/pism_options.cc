...
PetscErrorCode set_config_from_options(MPI_Comm /*com*/, NCConfigVariable &config) {
  ...
  ierr = config.keyword_from_option("inv_method","inv_ssa_method","sd,nlcg,ign,tikhonov_lmvm,tikhonov_cg,tikhonov_blmvm,tikhonov_lcl,tiknew_lmvm,tiknew_lcl"); CHKERRQ(ierr);
