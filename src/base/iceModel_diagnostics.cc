...
IceModel_hardav::IceModel_hardav(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "hardav"));
...
IceModel_rank::IceModel_rank(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "rank"));
...
IceModel_cts::IceModel_cts(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "cts", m_grid.z()));
...
IceModel_proc_ice_area::IceModel_proc_ice_area(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "proc_ice_area"));
...
IceModel_temp::IceModel_temp(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "temp", m_grid.z()));
...
IceModel_temp_pa::IceModel_temp_pa(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "temp_pa", m_grid.z()));
...
IceModel_temppabase::IceModel_temppabase(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "temppabase"));
...
IceModel_enthalpysurf::IceModel_enthalpysurf(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "enthalpysurf"));
...
IceModel_enthalpybase::IceModel_enthalpybase(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "enthalpybase"));
...
IceModel_tempbase::IceModel_tempbase(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "tempbase"));
...
IceModel_tempsurf::IceModel_tempsurf(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "tempsurf"));
...
IceModel_liqfrac::IceModel_liqfrac(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(),
                                           "liqfrac", m_grid.z()));
...
IceModel_flux_divergence::IceModel_flux_divergence(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "flux_divergence"));
...
IceModel_dHdt::IceModel_dHdt(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "dHdt"));
...
IceModel_floating_basal_flux_2D_cumulative::IceModel_floating_basal_flux_2D_cumulative(IceModel *m)
  ...
  // set metadata:
  m_vars.push_back(SpatialVariableMetadata(m_grid.ctx()->unit_system(), "floating_basal_flux_cumulative"));
