...
IceModel_hardav::IceModel_hardav(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "hardav", grid));
...
IceModel_rank::IceModel_rank(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "rank", grid));
...
IceModel_proc_ice_area::IceModel_proc_ice_area(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "proc_ice_area", grid));
...
IceModel_temppabase::IceModel_temppabase(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "temppabase", grid));
...
IceModel_enthalpysurf::IceModel_enthalpysurf(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "enthalpysurf", grid));
...
IceModel_enthalpybase::IceModel_enthalpybase(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "enthalpybase", grid));
...
IceModel_tempbase::IceModel_tempbase(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "tempbase", grid));
...
IceModel_tempsurf::IceModel_tempsurf(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "tempsurf", grid));
...
IceModel_tempicethk::IceModel_tempicethk(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "tempicethk", grid));
...
IceModel_tempicethk_basal::IceModel_tempicethk_basal(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "tempicethk_basal", grid));
...
IceModel_flux_divergence::IceModel_flux_divergence(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "flux_divergence", grid));
...
IceModel_climatic_mass_balance_cumulative::IceModel_climatic_mass_balance_cumulative(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "climatic_mass_balance_cumulative", grid));
...
IceModel_dHdt::IceModel_dHdt(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "dHdt", grid));
...
IceModel_nonneg_flux_2D_cumulative::IceModel_nonneg_flux_2D_cumulative(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "nonneg_flux_cumulative", grid));
...
IceModel_grounded_basal_flux_2D_cumulative::IceModel_grounded_basal_flux_2D_cumulative(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "grounded_basal_flux_cumulative", grid));
...
IceModel_floating_basal_flux_2D_cumulative::IceModel_floating_basal_flux_2D_cumulative(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "floating_basal_flux_cumulative", grid));
...
IceModel_discharge_flux_2D_cumulative::IceModel_discharge_flux_2D_cumulative(IceModel *m, IceGrid &g, Vars &my_vars)
  ...
  // set metadata:
  vars.push_back(NCSpatialVariable(grid.get_unit_system(), "discharge_flux_cumulative", grid));
