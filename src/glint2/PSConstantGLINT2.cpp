...
PSConstantGLINT2::PSConstantGLINT2(IceGrid &g, const ::Config &conf)
	: SurfaceModel(g, conf)
{
...
void PSConstantGLINT2::attach_atmosphere_model(AtmosphereModel *input)
{
	delete input;
}
...
*/
PetscErrorCode PSConstantGLINT2::init(Vars &vars)
{
...
void PSConstantGLINT2::get_diagnostics(std::map<std::string, Diagnostic*> &/*dict*/,
