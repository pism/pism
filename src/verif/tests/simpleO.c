/*
   Copyright (C) 2011, 2013, 2016 Ed Bueler
...
Results from Test O:
   ...
   bmelt = 8.80550e-04 (m year-1)
         = 0.88055 (mm year-1)    [ice-equivalent basal melt rate]
...
int main() {
  ...
  printf("   bmelt = %.5e (m year-1)\n"
         "         = %.5f (mm year-1)    [ice-equivalent basal melt rate]\n",
