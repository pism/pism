/*
   Copyright (C) 2010, 2013, 2016 Ed Bueler
...
Results from Test N:
     ...
     u    = ice velocity         =    300.00000 (m year-1)
     M    = surface mass balance =    -24.00000 (cm year-1)
...
int main() {
  ...
  printf("     H    = ice thickness        = %12.5f (m)\n"
         ...
         "     u    = ice velocity         = %12.5f (m year-1)\n"
         "     M    = surface mass balance = %12.5f (cm year-1)\n"
