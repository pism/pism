...
/*!
Runs numerical experiments reported in \lo\cite{BBssasliding}\elo.  There are four
experiments, P1,P2,P3,P4.  Each has four (or three for P2) ice streams generated by
lowered till friction angle.

This derived class supercedes an older class which produced results presented by
Bueler at AGU 2007 and at NYU in Feb 2008.  IcePSTexModel has no "lake" or "fjord",
which were present in the old version.
 */
