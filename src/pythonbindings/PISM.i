...
// Some of these includes draw in others, so this list could be reduced.
#include "grid.hh"
...
// The SWIG typecheck for a const char [] (used, e.g., with overloaded methods) checks that 
// the string is zero length! So we fix this here.
