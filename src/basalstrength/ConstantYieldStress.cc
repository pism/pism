// Copyright (C) 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2021, 2023, 2025, 2026 Constantine Khroulev
//
...
MaxTimestep ConstantYieldStress::max_timestep_impl(double t, const CFLData */*cfl_data*/) const {
  (void) t;
