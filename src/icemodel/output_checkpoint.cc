...
void IceModel::init_checkpoints() {
...

  {
    ...
    m_checkpoint_file_contents =
        pism::combine(m_checkpoint_file_contents, state_variables_for_diagnostics(m_checkpoint_vars));
    m_checkpoint_file_contents =
        pism::combine(m_checkpoint_file_contents, state_variables_for_diagnostics(m_spatial_vars));
    m_checkpoint_file_contents =
