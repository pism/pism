...
class DolfinGenericVector(AbstractVector):
    ...
    def __init__(self, u):
        if isinstance(u, dolfin.Function):
            ...
            raise ValueError(
                "An DolfinGenericVector only be constructed from a dolfin Function or a dolfin GenericVector: found a %s"
                % u
            )
...
class DolfinFunctionVector(AbstractVector):
    ...
    def __init__(self, u):
        if isinstance(u, dolfin.Function):
            ...
            raise ValueError(
                "An DolfinFunctionSpaceVector wraps a dolfin Function or FunctionSpace: found a %s"
                % u
            )
