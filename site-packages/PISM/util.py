...
def prepare_output(filename, append_time=True, time=None):
    ...
    output.define_dimension(time.get_name(), PISM.PISM_UNLIMITED)
    output.define_variable(time.get_name(), [time.get_name()],
                           time.get_output_type(), time.attributes())
