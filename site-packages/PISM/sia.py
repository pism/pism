# Copyright (C) 2011, 2012, 2014, 2015, 2016, 2017, 2018, 2020, 2021, 2022, 2024 David Maxwell and Constantine Khroulev
#
...
def computeSIASurfaceVelocities(modeldata, siasolver=PISM.SIAFD):
    ...
    try:
        inputs.no_model_mask = md.vecs.no_model_mask
        inputs.no_model_surface_elevation = md.vecs.usurfstore
        inputs.no_model_ice_thickness = md.vecs.thkstore
    except:
        pass

    sliding_velocity = PISM.Vector(grid, 'sliding_velocity')
    ...
    u_sia = PISM.Scalar(grid, 'u_sia')
    v_sia = PISM.Scalar(grid, 'v_sia')
