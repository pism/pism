# Copyright (C) 2011, 2014, 2015, 2016, 2017, 2018, 2019 David Maxwell and Constantine Khroulev
#
...
def createEnthalpyVec(grid, name='enthalpy', ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    stencil_width = _stencil_width(grid, ghost_type, stencil_width)
    enthalpy = PISM.IceModelVec3(grid, name, ghost_type, stencil_width)
...
def createStrainHeatingVec(grid, name='strain_heating',
    ...
    stencil_width = _stencil_width(grid, ghost_type, stencil_width)
    result = PISM.IceModelVec3(grid, name, ghost_type, stencil_width)
...
def createAgeVec(grid, name='age', ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    stencil_width = _stencil_width(grid, ghost_type, stencil_width)
    age = PISM.IceModelVec3(grid, name, ghost_type, stencil_width)
...
def create3DVelocityVecs(grid, ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    u = PISM.IceModelVec3(grid, "uvel", ghost_type, stencil_width)
    u.set_attrs("diagnostic", "x-component of the ice velocity", "m s-1", "m year-1", "", 0)

    v = PISM.IceModelVec3(grid, "vvel", ghost_type, stencil_width)
    v.set_attrs("diagnostic", "y-component of the ice velocity", "m s-1", "m year-1", "", 0)

    w = PISM.IceModelVec3(grid, "wvel_rel", ghost_type, stencil_width)
