...
def create3DVelocityVecs(grid, ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    u.metadata(0).long_name("x-component of the ice velocity").units("m s-1").glaciological_units("m year-1")

    v = PISM.Array3D(grid, "vvel", ghost_type, grid.z(), stencil_width)
    v.metadata(0).long_name("y-component of the ice velocity").units("m s-1").glaciological_units("m year-1")

    w = PISM.Array3D(grid, "wvel_rel", ghost_type, grid.z(), stencil_width)
    w.metadata(0).long_name("z-component of the ice velocity relative to the base directly below").units("m s-1").glaciological_units("m year-1")
...
def createBasalMeltRateVec(grid, name='bmelt', ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    bmr.metadata(0).long_name("ice basal melt rate in ice thickness per time").units("m s-1").glaciological_units("m year-1").standard_name("land_ice_basal_melt_rate")
...
def create2dVelocityVec(grid, name="", desc="", intent="", ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    for component in [0, 1]:
        vel.metadata(component).units("m s-1").glaciological_units("m year-1")
        for a in attrs:
...
def createCBarVec(grid, name="velbar_mag", ghost_type=PISM.WITHOUT_GHOSTS, stencil_width=None):
    ...
    velbar_mag.metadata(0).long_name("magnitude of vertically-integrated horizontal velocity of ice").units("m s-1").glaciological_units("m year-1")
...
def createLongitudeVec(grid, name="lon", ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    longitude.metadata(0).intent("mapping").long_name("longitude").units("degree_east").glaciological_units("degree_east").standard_name("longitude")
...
def createLatitudeVec(grid, name="lat", ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    latitude.metadata(0).intent("mapping").long_name("latitude").units("degree_north").standard_name("latitude")
