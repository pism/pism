...
def createIceMaskVec(grid, name='mask', ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    ice_mask.metadata().long_name("grounded_dragging_floating integer mask")
    mask_values = [PISM.ICE_FREE_LAND, PISM.ICY_LAND, PISM.ICE_FREE_LAKE, PISM.ICY_LAKE,
                   PISM.ICE_FREE_OCEAN, PISM.ICY_OCEAN]
