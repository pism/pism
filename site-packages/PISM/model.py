...
def createBCMaskVec(grid, name='bc_mask', ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    bc_mask = PISM.IceModelVec2Int(grid, name, ghost_type, stencil_width)
    bc_mask.set_attrs("model_state", "grounded_dragging_floating integer mask", "", "", "", 0)
    mask_values = [0, 1]
    bc_mask.metadata().set_numbers("flag_values", mask_values)
