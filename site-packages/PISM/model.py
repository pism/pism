...
import PISM, math
from PISM import util, netCDF, IceModelVec2S, IceModelVec2V
...
class ModelData:
  """
    A collection of data and physics comprising a PISM model.  The collection consists of
       ...
       * ``config``    the associated :cpp:class:`NCConfigVariable`
  ...
  def setPhysics(self,basal,enthalpyconverter):
    ...
    :param basal: An instance of :cpp:class:`PISMYieldStress`
...
def initGridFromFile(grid,input_file,periodicity=PISM.NOT_PERIODIC,variable='enthalpy'):
...
def createIceSurfaceVec(grid,name='usurf',ghost_type=PISM.kHasGhosts,stencil_width=None):
  """Returns an :cpp:class:`IceModelVec2S` with attributes setup for surface elevation data.
     ...
     :param ghost_type: One of ``PISM.kHasGhosts`` or ``PISM.kNoGhosts`` indicating if the vector is ghosted.
     :param stencil_width: The size of the ghost stencil. Ignored if ``ghost_type`` is ``PISM.kNoGhosts``.
                           If ``stencil_width`` is ``None`` and the vector is ghosted, the grid's maximum stencil
                           width is used."""
  if ghost_type==PISM.kHasGhosts:    
...
def createIceThicknessVec(grid,name='thk',ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createIceSurfaceStoreVec(grid,name='usurfstore',ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createIceThicknessStoreVec(grid,name='thkstore',ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createBedrockElevationVec(grid,name='topg',desc="bedrock surface elevation",
                                ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createEnthalpyVec(grid,name='enthalpy',ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createBasalMeltRateVec(grid,name='bmelt',ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def create2dVelocityVec(grid,name="",desc="",intent="",ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createVelocityMisfitWeightVec(grid,name="vel_misfit_weight",ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createCBarVec(grid,name="cbar",ghost_type=PISM.kNoGhosts,stencil_width=None):
...
def createIceMaskVec(grid,name='mask',ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createBCMaskVec(grid,name='bc_mask',ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createNoModelMaskVec(grid,name='no_model_mask',ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createLongitudeVec(grid,name="lon",ghost_type=PISM.kHasGhosts,stencil_width=None):
...
def createLatitudeVec(grid,name="lat",ghost_type=PISM.kHasGhosts,stencil_width=None):
