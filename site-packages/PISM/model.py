...
class ModelVecs:
  ...
  def lock(self):
    """Lock the internal collection, preventing further modification and
    preparing it for queries.

    """
    self._vecs.lock()

  def get(self, name):
    """:returns: the vector with the given *name*, raising an
    :exc:AttributeError if one is not found.
  ...
  def write(self, output_filename):
    ...
    vlist.sort(key=lambda v: v.name())
    for v in vlist:
