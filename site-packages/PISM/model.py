...
def _scalar_vec(grid, name, stencil_width):
    if stencil_width == 0:
        return PISM.IceModelVec2S(grid, name)

    if stencil_width == 1:
        return PISM.Array2SGhosted1(grid, name)

    if stencil_width == 2:
        return PISM.Array2SGhosted2(grid, name)

    raise ValueError("invalid stencil width: {}".format(stencil_width))

def _int_vec(grid, name, stencil_width):
    if stencil_width == 0:
        return PISM.IceModelVec2Int(grid, name)

    if stencil_width == 1:
        return PISM.Array2IGhosted1(grid, name)

    if stencil_width == 2:
        return PISM.Array2IGhosted2(grid, name)

    raise ValueError("invalid stencil width: {}".format(stencil_width))

def _cell_type_vec(grid, name, stencil_width):
    if stencil_width == 0:
        return PISM.IceModelVec2CellType(grid, name)

    if stencil_width == 1:
        return PISM.Array2CTGhosted1(grid, name)

    if stencil_width == 2:
        return PISM.Array2CTGhosted2(grid, name)
...
def createEnthalpyVec(grid, name='enthalpy', ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    stencil_width = _stencil_width(grid, ghost_type, stencil_width)
    enthalpy = PISM.IceModelVec3(grid, name, ghost_type, grid.z(), stencil_width)
...
def createStrainHeatingVec(grid, name='strain_heating',
    ...
    stencil_width = _stencil_width(grid, ghost_type, stencil_width)
    result = PISM.IceModelVec3(grid, name, ghost_type, grid.z(), stencil_width)
...
def createAgeVec(grid, name='age', ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    stencil_width = _stencil_width(grid, ghost_type, stencil_width)
    age = PISM.IceModelVec3(grid, name, ghost_type, grid.z(), stencil_width)
...
def create3DVelocityVecs(grid, ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    u = PISM.IceModelVec3(grid, "uvel", ghost_type, grid.z(), stencil_width)
    u.set_attrs("diagnostic", "x-component of the ice velocity", "m s-1", "m year-1", "", 0)

    v = PISM.IceModelVec3(grid, "vvel", ghost_type, grid.z(), stencil_width)
    v.set_attrs("diagnostic", "y-component of the ice velocity", "m s-1", "m year-1", "", 0)

    w = PISM.IceModelVec3(grid, "wvel_rel", ghost_type, grid.z(), stencil_width)
...
def createBCMaskVec(grid, name='vel_bc_mask', ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    vel_bc_mask = _int_vec(grid, name, stencil_width)
...
def createNoModelMaskVec(grid, name='no_model_mask', ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    no_model_mask = _int_vec(grid, name, stencil_width)
...
def createZetaFixedMaskVec(grid, name='zeta_fixed_mask', ghost_type=PISM.WITH_GHOSTS, stencil_width=None):
    ...
    zeta_fixed_mask = _int_vec(grid, name, stencil_width)
