...
def filename(prefix):
    return "/tmp/" + prefix + str(uuid.uuid4()) + ".nc"
...
def create_forcing(grid, file_name, variable_name, units, values,
    ...
    if time_bounds is not None:
        ...
        for k in range(len(values)):
            ...
            # write time bounds
            output.write_array(bounds.get_name(), [k, 0], [1, 2], (time_bounds[k], time_bounds[k + 1]))
