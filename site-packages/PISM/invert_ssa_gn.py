...
class InvSSASolver_Tikhonov:
  ...
  def solveInverse(self,zeta0,u_obs,zeta_inv):
    ...
    (designFunctional,stateFunctional) = PISM.invert_ssa.constructTikhonovFunctionals(self.ssarun)
    self.solver = PISM.InvSSATikhonovGN(self.ssarun.ssa,zeta0,u_obs,eta,designFunctional,stateFunctional)
