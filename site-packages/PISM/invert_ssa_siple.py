...
class InvSSASolver_Iterative:
  """Inverse SSA solver based on siple iterative methods."""
...
class SSAForwardProblem(NonlinearForwardProblem):
  ...
  The heavy lifting is forwarded to an :cpp:class:`IP_SSATaucForwardProblem`."""
