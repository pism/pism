...
class SSATaucForwardProblem(NonlinearForwardProblem):
  ...
  a :class:`PISM.invert_ssa.SSATaucForwardRun`."""

  def __init__(self,ssarun):
    """

    :param ssarun:  A :class:`PISM.invert_ssa.SSATaucForwardRun`
                    or :class:`PISM.invert_ssa.SSATaucForwardRunFromInputFile` defining
                    the forward problem."""
