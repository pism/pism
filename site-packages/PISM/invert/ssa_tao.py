...
class InvSSASolver_Tikhonov:
  ...
  def solveInverse(self,zeta0,u_obs,zeta_inv):
    ...
    elif design_var == 'hardness':
      if self.method == 'tikhonov_lcl':
        problemClass  = PISM.IP_SSAHardnessTaoTikhonovProblemLCL
        solverClass   = PISM.IP_SSAHardnessTaoTikhonovSolverLCL
        listenerClass = HardnessLCLIterationListenerAdaptor
      else:
        problemClass  = PISM.IP_SSAHardnessTaoTikhonovProblem
        solverClass   = PISM.IP_SSAHardnessTaoTikhonovSolver
        listenerClass = HardnessIterationListenerAdaptor
    else:
