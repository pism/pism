# Copyright (C) 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2021, 2022 David Maxwell and Constantine Khroulev
#
...
class SSAForwardRunFromInputFile(SSAForwardRun):
    ...
    def _initGrid(self):
        ...
        self.grid = PISM.Grid.FromFile(ctx, pio, "enthalpy", registration)
        pio.close()
