...
def createGradientFunctionals(ssarun):
  ...
  for o in PISM.OptionsGroup(grid.com,"","InvSSAFunctionals"):
      ...
      (misfit_type,wasSet) = PISM.optionsListWasSet(grid.com,'-inv_state_func',"Misfit functional type",['meansquare','log_relative','log_ratio'],'meansquare')
...
class PrintTikhonovProgress:
  ...
  def __call__(self,invssasolver,it,data):
    ...
    if self.misfit_type is None:
      for o in PISM.OptionsGroup(grid.com,"","SSATikhonovFunctionals"):
        (self.misfit_type,wasSet) = PISM.optionsListWasSet(grid.com,'-inv_state_func',"Misfit functional type",['meansquare','log_relative','log_ratio'],'meansquare')
