...
class SSAForwardRunFromInputFile(PISM.ssa.SSAFromInputFile):
  """Subclass of :class:`PISM.ssa.SSAFromInputFile` where the underlying SSA implementation is an 
  :cpp:class:`IP_SSATaucForwardProblem` or :cpp:class:`IP_SSAHardnessForwardProblem`. The vector data 
