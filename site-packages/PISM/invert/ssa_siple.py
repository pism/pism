# Copyright (C) 2012, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022 David Maxwell
#
...
class SSAForwardProblem(NonlinearForwardProblem):
    ...
    def rangeVector(self):
        ...
        v.set_attrs(intent, "%s%s" % ("X-component of the ", desc), "m s-1", "m year-1", "", 0)
        v.set_attrs(intent, "%s%s" % ("Y-component of the ", desc), "m s-1", "m year-1", "", 1)
