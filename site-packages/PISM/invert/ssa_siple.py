# Copyright (C) 2012, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021 David Maxwell
#
...
class SSAForwardProblem(NonlinearForwardProblem):
    ...
    def __init__(self, ssarun):
        ...
        self.tmpV = PISM.IceModelVec2V(self.grid, "work vector (2V)",
                                       PISM.WITHOUT_GHOSTS)

        self.tmpS = PISM.IceModelVec2S(self.grid, "work vector (2S)", PISM.WITHOUT_GHOSTS)

        self.tmpS2 = PISM.IceModelVec2S(self.grid, "work vector (2S)", PISM.WITHOUT_GHOSTS)
    ...
    def rangeVector(self):
        ...
        v = PISM.IceModelVec2V(self.grid, "", True, WIDE_STENCIL)
    ...
    def domainVector(self):
        ...
        v = PISM.IceModelVec2S(self.grid, "", True, WIDE_STENCIL)
        return PISMLocalVector(v)
