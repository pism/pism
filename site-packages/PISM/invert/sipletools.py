# Copyright (C) 2011, 2012, 2014, 2015, 2017, 2020 David Maxwell
#
...
class PISMLocalVector(siple.linalg.AbstractVector):
    ...
    def vector_like(self):
        if self.dof == 1:
            c = PISM.IceModelVec2S(self.grid, "", PISM.WITH_GHOSTS, self._core.stencil_width())
        else:
            c = PISM.IceModelVec2V(self.grid, "", PISM.WITH_GHOSTS, self._core.stencil_width())
