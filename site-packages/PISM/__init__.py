...
if imported_from_sphinx:
  ...
  SSAFD = None
  SIAFD = None
  IPTaucParamIdent = None
  IPTaucParamSquare = None
  IPTaucParamExp = None
  IPTaucParamTruncatedIdent = None
...
"""
  ...
  def init_config(self,overrides=None,unit_system=None,use_command_line_options=True):
    """Initializes the global :cpp:class:`NCConfigVariable`.
      ...
      :param overrides: A :cpp:class:`NCConfigVariable` to contain parameter overrides specified
                        via ``-config_override``.
    ...
    init_config(self.com, self.rank, self.config, overrides, use_command_line_options)
