...
class VerbPrintf:
  ...
  def println(self,msg,*args):
    msg = msg % args
    verbPrintf(self.verbosity,self.com,"%s\n",msg)

  def printlnv(self,verbosity,msg,*args):
    msg = msg % args    
    verbPrintf(verbosity,self.com,"%s\n",msg)
...
"""
  ...
  def config(self):
    ...
    if self._config is None:
      self._config = NCConfigVariable()
      self._overrides = NCConfigVariable()
      init_config(self.com, self.rank, self._config, self._overrides)
    return self._config
