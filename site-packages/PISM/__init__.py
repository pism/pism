# Copyright (C) 2011, 2014, 2015, 2016, 2018, 2019, 2021, 2025 David Maxwell and Constantine Khrulev
#
...
if not imported_from_sphinx:
    ...
    try:
        ...
        import sys
        try:
            # Defer this import until after the PETSc machinery is set up
            import importlib.util
            spec = importlib.util.find_spec("PISM.version_info")
            if spec is not None:
                version_info = importlib.util.module_from_spec(spec)
                spec.loader.exec_module(version_info)
                petsc4py.init(sys.argv, arch=version_info.PETSC_ARCH)
            else:
...
"""
    ...
    def __init_once__(self):
        ...
        self.petsc_initializer = PISM.PetscInitializer(0, None, "")
