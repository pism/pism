# Copyright (C) 2011, 2014, 2015, 2016, 2018, 2019, 2021, 2025, 2026 David Maxwell and Constantine Khrulev
#
...
# Importing PISM.cpp will initialize YAXT, YAC and PETSc. "import petsc4py" and
# "petsc4py.init(sys.argv)" are needed to be able to use the petsc4py API but will *not*
# initialize PETSc itself.
import PISM.cpp

import_symbols(PISM.cpp, globals())

import sys
pism_initialize_options(sys.argv)
...
def Config():
    "Allocate a configuration database and initialize using comman-line options"
    return PISM.config_from_options(PISM.PETSc.COMM_WORLD, PISM.UnitSystem())
...
"""
    ...
    def __init_once__(self):
        ctx = PISM.context_from_options(PETSc.COMM_WORLD, "python")
        self.ctx = ctx
