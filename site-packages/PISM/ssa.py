...
class SSARun:
  ...
  def write(self, filename):
    ...
    velbar_mag.mask_by(vecs.thk, self.grid.convert(-0.01, "m/year", "m/second"))
...
class SSAFromInputFile(SSARun):
  ...
  def _allocExtraSSACoefficients(self):
    ...
    if self.phi_to_tauc:
      vecs.add(PISM.model.createBasalMeltRateVec(grid))
      vecs.add(PISM.model.createTillPhiVec(grid))
      vecs.add(PISM.model.createBasalWaterVec(grid))
