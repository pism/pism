...
class SSAExactTestCase(SSARun):
    ...
    def report(self):
        ...
        PISM.verbPrintf(1, grid.com,
                        ...
                        PISM.convert(sys, gmaxvecerr, "m/second", "m/year"),
                        (gavvecerr / gexactvelmax) * 100.0,
                        PISM.convert(sys, gmaxuerr, "m/second", "m/year"),
                        PISM.convert(sys, gmaxverr, "m/second", "m/year"),
                        PISM.convert(sys, gavuerr, "m/second", "m/year"),
                        PISM.convert(sys, gavverr, "m/second", "m/year"))
...
class SSAFromInputFile(SSARun):
    ...
    def _initGrid(self):
        ...
        self.grid = PISM.model.initGridFromFile(PISM.Context().ctx, self.boot_file, periodicity)
