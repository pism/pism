...
class SSARun(object):
    ...
    def write(self, filename):
        ...
        pio = PISM.PIO(grid.com, "netcdf3", filename, PISM.PISM_READWRITE_MOVE)
    ...
    def _constructSSA(self):
        ...
        md = self.modeldata
        return SSAAlgorithms[md.config.get_string("stress_balance.ssa.method")](md.grid, md.enthalpyconverter)
