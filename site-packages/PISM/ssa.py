# Copyright (C) 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2021, 2022, 2023, 2024, 2025 David Maxwell and Constantine Khroulev
#
...
class SSARun(object):
    ...
    def write(self, filename, append=False):
        ...
        diagnostics = self.ssa.diagnostics()
