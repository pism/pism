# Copyright (C) 2011, 2012, 2013, 2014, 2015, 2017 David Maxwell and Constantine Khroulev
#
...
class SSARun(object):
    ...
    def write(self, filename):
        ...
        velbar_mag.metadata().set_double("_FillValue",
                                         PISM.convert(sys, -0.01, "m/year", "m/second"))
