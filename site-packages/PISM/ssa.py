...
class SSARun(object):
    ...
    def setup(self):
        ...
        5. :meth:`_constructSSA` -- build the :cpp:class:`SSA` solver
        6. :meth:`_initSSACoefficients` -- populate model vecs
        7. :meth:`_initSSA` -- final SSA initialization
    ...
    def write(self, filename, append=False):
        ...
        diagnostics = self.ssa.spatial_diagnostics()
    ...
    def _allocStdSSACoefficients(self):
        ...
        :meth:`_initSSACoefficients` implementations.
        """
        vecs = self.modeldata.vecs
        grid = self.grid
