# Copyright (C) 2012, 2015, 2016, 2018, 2019 David Maxwell
#
...
class CaptureLogger(object):
    ...
    def __call__(self, message, verbosity):
        ...
        if verbosity <= self.verbosity_threshold:
            ...
            d = PISM.File(PISM.Context().com, "netcdf3", self.filename, PISM.PISM_READWRITE)
            d.redef()
    ...
    def readOldLog(self):
        ...
        than overwriting it."""
        d = PISM.File(PISM.Context().com, "netcdf3", self.filename, PISM.PISM_READONLY)
    ...
    def write(self, filename=None, attribute=None):
        ...
        if attribute is None:
            attribute = self.attr
        d = PISM.File(PISM.Context().com, "netcdf3", filename, PISM.PISM_READWRITE)
        d.redef()
