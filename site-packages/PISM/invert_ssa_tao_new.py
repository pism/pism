...
class InvSSASolver_Tikhonov:
  ...
  tao_types = {'tiknew_lmvm':'tao_lmvm', 'tikhonov_lmvm':'tao_lmvm', 'tikhonov_cg':'tao_cg', 'tikhonov_lcl':'tao_lcl', 'tikhonov_blmvm':'tao_blmvm'}
  ...
  def solveInverse(self,zeta0,u_obs,zeta_inv):
    ...
    if self.method == 'tikhonov_lcl':
      raise NotImplementedError('tikhonov_lcl not yet available')
    else:
