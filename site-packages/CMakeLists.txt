...
if (Pism_BUILD_PYTHON_BINDINGS)
  install (PROGRAMS
    ${CMAKE_SOURCE_DIR}/examples/python/ssa_forward.py
    ${CMAKE_SOURCE_DIR}/examples/python/sia_forward.py
    ${CMAKE_SOURCE_DIR}/examples/inverse/make_synth_ssa.py
    ${CMAKE_SOURCE_DIR}/examples/inverse/vel2tauc.py
    ${CMAKE_SOURCE_DIR}/examples/inverse/verify_ssa_inv.py
