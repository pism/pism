...
It uses a set of three equations describing (1) the energy balance, (2) the salinity balance, and (3) the pressure and salinity dependent freezing point in the boundary layer \cite{Hellmeretal1998}. Temperature and salinity in the boundary layer are equilibrated by fluxes from the adjacent mixed ocean waters and the ice and by the melting or refreezing of ice.
