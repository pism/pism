...
\begin{center}
  \begin{tabular}{lp{0.7\textwidth}}
    \toprule
    Variable names: & \variable{precipitation_anomaly}, \variable{air_temperature_anomaly}\\
...
$ pclimate -i green20km_y1.nc -o dT_movie.nc \
           -atmosphere eismint_greenland,delta_T -atmosphere_delta_T_file grip_dT.nc \
           -times -2.5e5:2000:0
\end{verbatim}%$
...
\begin{verbatim}
$ pclimate -i green20km_y1.nc -o bar.nc -times -125000.0:1000:0 \
           -atmosphere_delta_T_file grip_dT.nc -ocean_delta_SL_file specmap_dSL.nc \
           -atmosphere eismint_greenland,delta_T -surface pdd -ocean constant,delta_SL
\end{verbatim}%$
\end{comment}
...
This model~component was created to force PISM with sampled (possibly periodic) climate data, e.g. using monthly records of \variable{air_temperature} and \variable{precipitation}.
