...
\fileopt{force_to_thickness_file} causes $M$ to be modified by a multiple of the
...
In this case \texttt{foo.nc} contains fields \variable{climatic_mass_balance} and \variable{ice_surface_temp}, as normal for \texttt{-surface~given}, and \texttt{bar.nc} contains field
