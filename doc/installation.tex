...
$  mkdir pism0.5/build
$  cd pism0.5/build
$  PISM_INSTALL_PREFIX=~/pism cmake ..   # FIXME: is "pism0.5/" meant?
$  make install
\end{verbatim}
...
cd pism/build
\end{verbatim}
\item Because CMake's configuration mechanism cannot locate libraries and headers
automatically, because Cray doesn't use standard locations, we provide a
