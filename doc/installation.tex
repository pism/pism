...
\subsection{Installing PISM on a Cray XK6 system}
\label{sec:cray}
...
set (UDUNITS2_LIBRARY "/path/to/udunits2/lib/libudunits2.a;/path/to/libexpat.s"
 CACHE STRING "" FORCE)
...
\item You can set \texttt{Pism_LOOK_FOR_LIBRARIES} to ``\texttt{OFF}''
  ...
  section \ref{sec:cray} for an example.
\end{itemize}
