...
\bigskip
\normalspacing
The following table lists the \emph{required} dependencies for PISM, arranged alphabetically.  (Before installing these ``by hand'', check the Debian and Mac OS X sections below for specific how-to.)
\bigskip
...
$  make all test
\end{verbatim}
\item Finally, to build PISM, see section \ref{sec:pism-itself}.
