...
If you are using a Debian-based system such as Ubuntu, you can download and install the
``pism toolkit'' meta-package to make sure that all prerequisite tools and libraries\footnote{Except PETSc.} are installed. (You still need to build
PISM from sources.)
