...
\begin{table}[ht]
  ...
  \begin{tabular}{p{0.35\linewidth}p{0.55\linewidth}}\toprule
    ...
    \intextoption{split_snapshots} & Separate the snapshot output into files
