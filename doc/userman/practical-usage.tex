...
\begin{table}[ht]
  ...
  \begin{tabular}{p{0.4\linewidth}p{0.1\linewidth}p{0.4\linewidth}}\toprule
   ...
   \midrule
    ...
    \texttt{ivolcold} &m$^{3}$ & cold ice volume\\
    \texttt{ivoltemp} &m$^{3}$ & temperate ice volume\\
    \texttt{iarea} & m$^{2}$ & total area covered by ice \\
    \texttt{iareacold} & m$^{2}$ & area covered by cold ice \\
    \texttt{iareatemp} & m$^{2}$ & area covered by temperate ice \\
