...
\texttt{pclimate}\index{executables!pclimate} allows one to visualize climate inputs without
...
\listopt{regrid_vars} commands as in this example:\index{executables!pisms}
...
\texttt{-boot_from}\index{refining the grid}:
\begin{verbatim}
...
Here is an example.  Suppose we start a long verification run in the background, with standard out redirected into a file:\index{executables!pismv}
