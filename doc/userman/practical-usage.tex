...
\begin{center}
  \begin{tabular}{p{0.35\linewidth}p{0.55\linewidth}}\toprule
    ...
    \intextoption{ksp_monitor_draw} & Iteration monitor for the Krylov subspace routines (KSP) in PETSc. Shows norm of residual versus iteration number.\\\bottomrule
    \normalsize
  \end{tabular}
\end{center}
