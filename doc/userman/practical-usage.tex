...
\begin{table}[ht]
  ...
  \begin{tabular}{p{0.4\linewidth}p{0.1\linewidth}p{0.4\linewidth}}
    ...
    \texttt{gDmax} & m$^{2}$ s$^{-1}$ & maximum diffusivity \\
...
\begin{center}
  \begin{xtabular}{p{0.15\linewidth}p{0.15\linewidth}p{0.6\linewidth}}
   ...
   \texttt{diffusivity} & m$^{2}$ / s & diffusivity coefficient $D$ in
    ...
    \texttt{tempicethk_basal} & m & thickness of the basal layer of temperate ice \\
    ...
    \texttt{velbar} & m/year & vertical mean of horizontal ice velocity (both components) \\
    \texttt{velbase} & m/year & basal ice velocity (both components)\\
    \texttt{usurf} & m & ice upper surface elevation \\
    \texttt{uvel} & m/year & horizontal velocity of ice in the X direction \\
   \texttt{velsurf} & m/year & horizontal ice velocity at the ice surface (both
   components) \\
