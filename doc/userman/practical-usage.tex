...
\begin{table}[ht]
  ...
  \begin{tabular}{p{0.15\linewidth}p{0.15\linewidth}p{0.6\linewidth}}
    ...
    \texttt{discharge_flux_cumulative} & \textsl{Gt m-2} & cumulative ice discharge (calving) flux \\
