...
\begin{table}[ht]
  ...
  \begin{tabular}{p{0.4\linewidth}p{0.5\linewidth}}\toprule
    ...
    \txtopt{viewer_size}{number} & desired viewer size, in pixels\\
...
You can find an example "fake EBM" Python script in the "\texttt{util}"
directory of the PISM source tree, \texttt{util/ebm}.
