...
\item \textbf{PISM atmosphere models.}
  ...
  \item \emph{Constant in time} (\verb|constant|)
    ...
    This atmosphere model reads the snow precipitation (variable \verb|snowprecip|) and the mean annual near-surface air temperature (variable \verb|temp_ma|) and provides then to a selected surface model.
