...
\bottomrule\normalsize
\end{tabular}
\label{tab:MISMIPoptions}
\caption{Special MISMIP run options in PISM.  Below the line are special interpretations of standard PISM options.\index{PISM!special options for MISMIP experiments}}
\end{table}
