...
L & isothermal SIA, steady, non-flat bed & numerical ODE soln & [IN PREP] \\ \bottomrule
\normalsize
\end{tabular}
...
J & \texttt{ssa_testj -ssa_method fd -Mx 60 -My 60 -Mz 11 -ssafd_ksp_rtol 1e-12} \\ % FIXME: use .py 
