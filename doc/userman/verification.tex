...
\begin{table}[ht]
\centering
\caption{Canonical PISM\index{executables!pismv!options to run verification tests}\index{verification tests} verification runs using the exact solutions listed in table \ref{tab:tests}.}\label{tab:tests-exec}
\small
...
\texttt{test/vfnow.py} \index{executables!python scripts!vfnow.py} and \texttt{test/vnreport.py} \index{executables!python scripts!vnreport.py}.  See subsection \ref{subsect:scripts}.
