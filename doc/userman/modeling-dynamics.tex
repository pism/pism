...
\subsubsection*{Choosing the flow laws for SIA and SSA stress balances}  Command-line options \intextoption{sia_flow_law} and \intextoption{ssa_flow_law} choose which flow law is used by the SIA and SSA ice dynamics models, respectively.  Allowed arguments are listed in Tables \ref{tab:flowlaw} and \ref{tab:flowlawgk} below.
...
FIXME: add text on \texttt{-sXa_n} and how to adjust the enhancement factor accordingly
