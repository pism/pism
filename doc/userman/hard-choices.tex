...
%FIXME:  why?  esp. under r1281, should we allow "-dTforcing foo.nc -anomaly_temp bar.nc"?
...
\end{itemize}
  ...
  \item \emph{Elevation-dependent temperature and mass balance} (\texttt{elevation})
    ...
    This surface model parametrizes the ice surface temperature $T_{h}$ = \texttt{artm} and the surface mass balance $m$ = \texttt{acab} as \emph{piecewise-linear} functions of surface elevation $h$.
