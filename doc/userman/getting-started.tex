...
\begin{figure}[ht]
\includegraphics[width=2.4in,keepaspectratio=true]{sr-greenland_thk}
 \quad\includegraphics[width=2.4in,keepaspectratio=true]{sr-greenland_prcp}
\caption{The input present-day ice thickness (left) and present-day precipitation (right) for SeaRISE-Greenland.}
\label{fig:sr-input1}
\end{figure}

\begin{figure}[ht]
\includegraphics[width=2.4in,keepaspectratio=true]{sr-greenland_topg}
 \quad \includegraphics[width=2.4in,keepaspectratio=true]{sr-greenland_bheatflx}\caption{The input bedrock elevation (left) and geothermal flux (right) for SeaRISE-Greenland.}
\label{fig:sr-input2}
\end{figure}
