...
\begin{figure}[ht]
\centering
%  FIXME: PLACEHOLDERS ONLY FOR NOW!  add temppabase from last time in ex_g10km_steady.nc and driving stress taud from g10km_SIA.nc
\mbox{\includegraphics[width=2.0in,keepaspectratio=true]{temppabase}
  \qquad \includegraphics[width=2.0in,keepaspectratio=true]{taud}}
...
\begin{figure}[ht]
\centering
%  FIXME: PLACEHOLDERS ONLY FOR NOW!  add thk, cbase, csurf from g10km_0.nc
\mbox{\includegraphics[width=2.0in,keepaspectratio=true]{thk}
