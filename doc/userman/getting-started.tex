...
\begin{figure}[ht]
\centering
\mbox{\includegraphics[height=2.75in,keepaspectratio=true]{g20km-25ka-paleo-usurf} \includegraphics[height=2.75in,keepaspectratio=true]{g20km-25ka-paleo-csurf} \includegraphics[height=2.75in,keepaspectratio=true]{g20km-25ka-paleo-cbase}}
\caption{Fields from output file \texttt{g20km_25ka_paleo.nc}.  Compare Figure \ref{fig:secondoutputcoarse}, which only differs by climate inputs and run length.  Left: \texttt{usurf} in meters.  Middle: \texttt{csurf} in m/a.  Right: \texttt{cbase} in m/a.}
\label{fig:paleooutput}
\end{figure}
...
Results from file \texttt{g20km_25ka_paleo.nc} are shown in Figure \ref{fig:paleooutput}.  Without close inspection they appear to be very similar to the results in Figure \ref{fig:secondoutputcoarse}.  Of course these runs only differ in the applied climate and run duration.
