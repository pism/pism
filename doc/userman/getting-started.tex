...
The intention of this run was to generate a minimal model of the Greenland ice sheet in approximate steady-state with a steady (constant-in-time) climate.  Figure \ref{fig:firstoutput} shows some fields from \texttt{g20km_10ka.nc}.
...
\caption{Fields from output file \texttt{g20km_10ka.nc}.  Left: \texttt{usurf}, the ice sheet surface elevation in meters.  Middle: \texttt{csurf}, the surface velocity in meters/year, including the 100 meter/year contour (solid black).  Right: \texttt{mask}, with 0 = ice-free land, 2 = ice, 4 = ice-free ocean.}
...
% $ ncdump -h g20km_10ka_hybrid.nc |"grep" history
%		:history = "bueler@bueler-lemur 2013-11-23 17:36:55 AKST: PISM done.  Performance stats: 0.1649 wall clock hours, 0.6598 proc.-hours, 15146.2867 model years per proc.-hour, PETSc MFlops = 264118.55.\n",
%bueler@bueler-lemur ~/pism/examples/std-greenland[dev*]$ octave
%>> 0.1649*60
%ans =  9.8940
