#!/usr/bin/env python
"""This script creates the graph of the modeled volume time series
...
figure(figsize=(12,6))
plot(t20km, ivol20km / vfactor, 'b', linewidth=2.0), hold(True)
plot(t10km, ivol10km / vfactor, 'r', linewidth=2.5), hold(False)
legend(('20 km','10 km'), loc='lower right')
