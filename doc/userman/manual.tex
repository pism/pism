...
%    {\Large Constantine Khroulev \\ Ed Bueler \\ Andy Aschwanden \\ Jed Brown \\ Nathan Shemonski}
    ...
    \includegraphics[width=3.3in,keepaspectratio=true]{grn-grl-csurf}
    \vfill
...
\bigskip\bigskip
\noindent \textsc{Front page}: Magnitude of horizontal surface velocy as simulated by PISM employing a horizontal grid resolution of 2\,km. Visualization done with IDV.
