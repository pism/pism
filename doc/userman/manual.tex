...
\usepackage[pdftex]{hyperref}[2010/03/30 v6.80u Hypertext links for LaTeX]
...
\opt{options_left}  Shows an options table which will indicate if a user option was not read or was misspelled.
