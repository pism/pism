...
\normalspacing
PISM is a joint project between developers in the ice sheet modeling group at the University of Alaska (UAF) and at the Potsdam Institute for Climate Impact Research (PIK).  The list of designers, source code authors, documentation authors, and script contributors is substantial; current/recent affiliation and area of contributions shown:
\bigskip
\normalspacing
