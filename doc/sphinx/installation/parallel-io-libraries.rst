...
PISM supports several parallel I/O approaches that take advantage of parallel NetCDF_ and
PnetCDF_. The administrators of your HPC system should be able to help you install these
libraries, but it may be easier to install them in the "home" directory instead.
