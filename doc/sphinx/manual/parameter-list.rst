...
#. :config:`basal_resistance.pseudo_plastic.enabled` (*boolean*)

   :Value: no
   :Option: :opt:`-pseudo_plastic`
   :Description: Use the pseudo-plastic till model (basal sliding law).

#. :config:`basal_resistance.pseudo_plastic.q` (*scalar*)
...
#. :config:`basal_resistance.pseudo_plastic.sliding_scale_factor` (*scalar*)
...
#. :config:`basal_yield_stress.constant.value` (*scalar*)
...
#. :config:`basal_yield_stress.mohr_coulomb.till_cohesion` (*scalar*)
...
#. :config:`basal_yield_stress.mohr_coulomb.till_compressibility_coefficient` (*scalar*)
...
#. :config:`basal_yield_stress.mohr_coulomb.till_effective_fraction_overburden` (*scalar*)
...
#. :config:`basal_yield_stress.mohr_coulomb.till_log_factor_transportable_water` (*scalar*)
...
#. :config:`basal_yield_stress.mohr_coulomb.till_phi_default` (*scalar*)
...
#. :config:`bed_deformation.lc.elastic_model` (*boolean*)
...
#. :config:`bed_deformation.bed_uplift_file` (*string*)
...
#. :config:`calving.eigen_calving.K` (*scalar*)
...
#. :config:`calving.front_retreat.wrap_around` (*boolean*)
...
#. :config:`calving.front_retreat.use_cfl` (*boolean*)
...
#. :config:`calving.thickness_calving.threshold` (*scalar*)
...
#. :config:`calving.thickness_calving.threshold_file` (*string*)
...
#. :config:`energy.minimum_allowed_temperature` (*scalar*)
...
#. :config:`fracture_density.constant_healing` (*boolean*)

   :Value: no
   :Option: :opt:`-constant_healing`
   :Description: Constant healing

#. :config:`fracture_density.enabled` (*boolean*)

   :Value: no
   :Option: :opt:`-fractures`
   :Description: Calculation of fracture density according to stresses and strain rate field.

#. :config:`fracture_density.fd2d_scheme` (*boolean*)

   :Value: no
   :Option: :opt:`-scheme_fd2d`
   :Description: FIXME

#. :config:`fracture_density.fracture_weighted_healing` (*boolean*)

   :Value: no
   :Option: :opt:`-fracture_weighted_healing`
   :Description: Fracture weighted healing

#. :config:`fracture_density.include_grounded_ice` (*boolean*)

   :Value: no
   :Option: :opt:`-do_frac_on_grounded`
   :Description: model fracture density in grounded areas

#. :config:`fracture_density.lefm` (*boolean*)

   :Value: no
   :Option: :opt:`-lefm`
   :Description: FIXME

#. :config:`fracture_density.max_shear_stress` (*boolean*)

   :Value: no
   :Option: :opt:`-max_shear`
   :Description: Use the max. shear stress criterion.

#. :config:`fracture_density.phi0` (*scalar*)

   :Value: 0 (1)
   :Option: :opt:`-phi0`
   :Description: FIXME

#. :config:`fracture_density.softening_lower_limit` (*scalar*)
...
#. :config:`fracture_density.write_fields` (*boolean*)
...
#. :config:`hydrology.cavitation_opening_coefficient` (*scalar*)
...
#. :config:`hydrology.const_bmelt` (*scalar*)
...
#. :config:`hydrology.creep_closure_coefficient` (*scalar*)
...
#. :config:`hydrology.gradient_power_in_flux` (*scalar*)
...
#. :config:`hydrology.hydraulic_conductivity` (*scalar*)
...
#. :config:`hydrology.roughness_scale` (*scalar*)
...
#. :config:`inverse.design.param` (*keyword*)
...
#. :config:`output.file_name` (*string*)
...
#. :config:`output.runtime.viewer.variables` (*string*)

   :Value: *no default*
   :Option: :opt:`-view`
   :Description: comma-separated list of map-plane diagnostic quantities to view at runtime

#. :config:`output.runtime.volume_scale_factor_log10` (*integer*)
...
#. :config:`output.save_size` (*keyword*)
...
#. :config:`regional.no_model_strip` (*scalar*)
...
#. :config:`run_info.institution` (*string*)
...
#. :config:`stress_balance.calving_front_stress_bc` (*boolean*)
...
#. :config:`stress_balance.sia.Glen_exponent` (*scalar*)

   :Value: 3 (pure number)
   :Option: :opt:`-sia_n`
   :Description: Glen exponent in ice flow law for SIA

#. :config:`stress_balance.sia.bed_smoother_range` (*scalar*)
...
#. :config:`stress_balance.sia.e_age_coupling` (*boolean*)

   :Value: no
   :Option: :opt:`-e_age_coupling`
   :Description: Couple the SIA enhancement factor to age as in :cite:`Greve`.

#. :config:`stress_balance.sia.enhancement_factor` (*scalar*)

   :Value: 1 (1)
   :Option: :opt:`-sia_e`
   :Description: Flow enhancement factor for SIA

#. :config:`stress_balance.sia.enhancement_factor_interglacial` (*scalar*)
...
#. :config:`stress_balance.sia.flow_law` (*keyword*)
...
#. :config:`stress_balance.sia.grain_size_age_coupling` (*boolean*)
...
#. :config:`stress_balance.sia.surface_gradient_method` (*keyword*)
...
#. :config:`stress_balance.ssa.Glen_exponent` (*scalar*)
...
#. :config:`stress_balance.ssa.enhancement_factor` (*scalar*)

   :Value: 1 (1)
   :Option: :opt:`-ssa_e`
   :Description: Flow enhancement factor for SSA

#. :config:`stress_balance.ssa.enhancement_factor_interglacial` (*scalar*)
...
#. :config:`stress_balance.ssa.epsilon` (*scalar*)
...
#. :config:`stress_balance.ssa.fd.brutal_sliding` (*boolean*)

   :Value: false
   :Option: :opt:`-brutal_sliding`
   :Description: Enhance sliding speed brutally.

#. :config:`stress_balance.ssa.fd.brutal_sliding_scale` (*scalar*)
...
#. :config:`stress_balance.ssa.fd.max_iterations` (*integer*)

   :Value: 300
   :Option: :opt:`-ssa_maxi`
   :Description: Maximum number of iterations for the ice viscosity computation, in the SSAFD object

#. :config:`stress_balance.ssa.fd.nuH_iter_failure_underrelaxation` (*scalar*)
...
#. :config:`stress_balance.ssa.fd.relative_convergence` (*scalar*)
...
#. :config:`stress_balance.ssa.method` (*keyword*)
...
#. :config:`surface.pdd.temperature_standard_deviation_file` (*string*)
...
#. :config:`time_stepping.count_steps` (*boolean*)
...
#. :config:`time_stepping.hit_extra_times` (*boolean*)
...
#. :config:`time_stepping.hit_multiples` (*scalar*)
...
#. :config:`time_stepping.hit_save_times` (*boolean*)
