...
#. NetCDF variables should have the ``units`` containing a UDUNITS-2-compatible string. If
...
.. [#] PISM uses a library called UDUNITS_ to convert data present in an input file to
       MKS. This means that having ice thickness in feet or temperature in Fahrenheit *is*
       allowed.
