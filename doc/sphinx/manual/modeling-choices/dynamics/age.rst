...
an argument in the format identical to :config:`output.spatial.times`; see
...
.. note::
   ...
   (:config:`output.spatial.append`) when re-starting a simulation. A restarted simulation
