...
\title[COMMVNISM: A User's and Developer's Manual]{A \underline{C}++ \underline{O}bject-oriented \underline{M}ulti-\underline{M}odal, \underline{V}erifiable \\ \underline{N}umerical \underline{I}ce \underline{S}heet \underline{M}odel: \\ A User's and Developer's Manual}

\author{Jed Brown and Ed Bueler}

\date{\today.  This manual documents a C++ implementation of a numerical ice sheet model developed by Jed Kallen-Brown, Ed Bueler, and Craig Lingle}
