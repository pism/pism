...
Note the choice of the height of the computational box (``\verb|-Lz 4000|''), of the number of vertical levels (``\verb|-Mz 21|''), and of a not-equally-spaced grid (``\verb|-quadZ|''; currently UNDOCUMENTED OPTION).  The messages to standard out show that the vertical spacing is less than 30 m near the base and more than 130 m at the top of the computational box (where it matters less to have a fine grid).
