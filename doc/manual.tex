...
pisms -eisII A -Mx 61 -My 61 -Mz 61 -z_spacing quadratic -skip 5 -y 2e5 -o eisIIA_quadZ.nc
\end{verbatim}
...
\begin{table}[ht]
\caption{Running the EISMINT II experiments in PISM.\index{PISM!running the EISMINT II experiments in}  Replace \t{-Mz 201} with \t{-Mz 61 -z\und spacing quadratic} for unequal vertical spacing.  Use \t{-skip 5} for significant speedup.}\label{tab:eisII}
\small
\begin{tabular}{@{}llll}\hline
...
\begin{verbatim}
pisms -eisII I -ssa -super -plastic -track_Hmelt -Mx 91 -My 91 -Mz 51 -z_spacing quadratic \
