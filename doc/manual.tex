...
(mean annual temperature at ice surface but below firn), \verb|artmpdd|
(instantaneous snow temperature) and \verb|snowaccum| (mean annual
ice-equivalent snow accumulation rate).

Variables \verb|artm| and \verb|snowaccum| do not evolve over time because the 
