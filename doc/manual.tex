...
\caption{Numerical thickness errors in test G.  Vertical axis is in meters. ``maxH error'' is the maximum thickness error anywhere on the grid, ``avH error'' is the average thickness error anywhere on the grid.  See \cite{BBL} and \cite{BLKCB}.}
...
\begin{figure}[ht]
\includegraphics[width=4.0in,keepaspectratio=true]{figs/test-I-errors}
...
\begin{figure}[ht]
\includegraphics[width=4.0in,keepaspectratio=true]{figs/test-K-errors}
...
\opt{id}  Sets the x grid index at which a sounding diagnostic viewer (Appendix \ref{sect:viewers}) is displayed.  The integer argument should be in the range $0,\dots,\text{\t{Mx}}-1$.  The default is $(\text{\t{Mx}}-1)/2$ at the center of the grid.  For example, \verb|pismv -test G -view_sounding temp -id 10|.

\opt{jd}  Sets the y grid index at which a sounding diagnostic viewer (Appendix \ref{sect:viewers}) is displayed.  The integer argument should be in the range $0,\dots,\text{\t{My}}-1$.  The default is $(\text{\t{My}}-1)/2$ at the center of the grid.  For example, \verb|pismv -test G -view_sounding temp -jd 10|.
