...
When the full 200,000 year run finishes, one may watch its evolving state by

\verb|pisms -eisII A -if eisIIA200k.nc -d HTt|
...
\caption{Diagnostic figures at the end of a 200,000 year EISMINT II experiment A run.}
