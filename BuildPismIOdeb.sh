...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/work/bk0993/k202136/cdi-1.9.9-gcc-openmpi2/lib
...
$CMAKE -DCMAKE_FIND_ROOT_PATH="/work/bk0993/k202136/netcdf-c-4.7.4-gcc64-openmpi2;/work/bk0993/k202136/pnetcdf-1.12.1-gcc-openmpi2;/work/bk0993/k202136/pio-2.5.2-gcc-openmpi2;/work/bk0993/k202136/cdi-1.9.9-gcc-openmpi2" -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DCMAKE_INSTALL_PREFIX=$PISM_INSTALL_PREFIX -DPism_BUILD_EXTRA_EXECS:BOOL=OFF -DPETSC_EXECUTABLE_RUNS=ON -DPism_USE_JANSSON=NO -DPism_USE_PIO=YES -DPism_USE_PARALLEL_NETCDF4=YES -DPism_USE_PNETCDF=YES -DPism_USE_CDI=YES -DMPIEXEC=srun -DHDF5_C_LIBRARY_z=$ZLIBROOT/lib/libz.so -DHDF5_C_LIBRARY_hdf5=$HDF5ROOT/lib/libhdf5.so.10 -DHDF5_C_LIBRARY_hdf5_hl=$HDF5ROOT/lib/libhdf5_hl.so.10 --debug-trycompile ../.
