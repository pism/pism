...
parser.add_argument(
    "-a", "--start_date", dest="start_date", help="""Start date in ISO format. Default=1989-1-1""", default="1989-1-1"
)
parser.add_argument(
    "-e", "--end_date", dest="end_date", help="""End date in ISO format. Default=2012-1-1""", default="2012-1-1"
)
parser.add_argument(
    "-i",
    "--interval_type",
...
parser.add_argument(
    "-d", "--ref_date", dest="ref_date", help="""Reference date. Default=1960-1-1""", default="1960-1-1"
)
