...
parser.add_option(
    "-o", dest="output_file_prefix", default="ssafd_test", help="output file prefix"
)
parser.add_option(
    "-L", dest="L", type=float, default=10.0, help="horizontal domain dimensions, km"
)
parser.add_option(
    "-H", dest="H", type=float, default=500.0, help="ice thickness in icy areas"
)
...
def run_pismr(input_filename, output_filename):
    command = (
        "pismr -i %s -bootstrap -o %s -Mx %d -My %d -Lz 1000 -Mz 5 -stress_balance ssa+sia -cfbc -y 0.001 -verbose 1"
