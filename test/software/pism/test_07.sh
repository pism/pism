...
run_test ()
{
    ...
    run pismv -test G -Lx 4000 -Ly 4000 -Lz 4000 -Mx 41 -My 41 -y 0 -o foo.nc

    # Bootstrap from this file:
    run pismr -boot_from foo.nc -Lx 2000 -Ly 2000 -Lz 4000 -Mx 41 -My 41 -y 0 -o bar.nc
    ...
    # Compare:
    run nccmp.py -t 1e-16 -v topg bar.nc baz.nc
    if [ $? != 0 ];
    then
