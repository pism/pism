...
for NN in $NRANGE;
do 
    $MPIEXEC -n $NN $PISM_PATH/pismr -boot_file foo0-10.nc -Mx 51 -My 101 -Mz 11 -Lz 5000 -y 0 -o foo$NN-10.nc -o_size small
done
...
do
	...
	$PISM_PATH/nccmp.py foo$i-10.nc foo$j-10.nc
	if [ $? != 0 ];
	then
	    exit 1
	fi
