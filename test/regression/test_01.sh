...
$PISM_PATH/pisms -i baz-01.nc $OPTS -y 5 -o joe-01.nc
$PISM_PATH/pisms -i joe-01.nc $OPTS -y 5 -o bar-01.nc

set +e

# Compare output files at year 10:
$PISM_PATH/nccmp.py -v bmelt,enthalpy,thk,topg,tillwat foo-01.nc bar-01.nc
if [ $? != 0 ];
then
    exit 1
fi
