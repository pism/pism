...
$PISM_PATH/pismv -test G -Lx 4000 -Ly 4000 -Lz 4000 -Mx 41 -My 51 -Mz 31 -y 0 -o foo-07.nc 

# Bootstrap from this file:
$PISM_PATH/pismr -boot_file foo-07.nc -Lx 2000 -Ly 2000 -Lz 4000 -Mx 31 -My 41 -Mz 51 $OPTS -o bar-07.nc 
