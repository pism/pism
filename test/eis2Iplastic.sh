...
mpiexec -n $NN pisms -eis2Ipl -if eis2I_final.nc -ys 0 -y 10 -f3d \
...
mpiexec -n $NN pisms -eis2Ipl -if eis2I_final.nc -ys 0 -y 5000 -f3d \
...
mpiexec -n $NN pisms -eis2Ipl -Mx 61 -My 61 -Mz 251 -ys 0 -y 5000 -f3d \
...
mpiexec -n $NN pisms -eis2Ipl -Mx 201 -My 201 -Mz 251 -ys 0 -y 5000 -f3d \
...
mpiexec -n $NN pisms -eis2Ipl -Mx 121 -My 121 -Mz 501 -ys 0 -y 5000 -f3d \
