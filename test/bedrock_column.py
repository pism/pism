...
k = ctx.config.get_double("energy.bedrock_thermal_conductivity")
c = ctx.config.get_double("energy.bedrock_thermal_specific_heat_capacity")
rho = ctx.config.get_double("energy.bedrock_thermal_density")
K = k / c
# alpha squared
alpha2 = k / (c * rho)
