...
% author Paul Spencer
% source: found at http://www.mathworks.com/matlabcentral/

% to use on PISM-produced files, first apply an NCO to write in "classic" NetCDF:
%    $  ncks --fl_fmt=classic foo.nc bar.nc   # converts PISM-written foo.nc to classic bar.nc
%    $  matlab -nosplash &
% then, inside matlab,
%    >> S=netcdf('bar.nc')
% and to plot ice thickness it is probably
%    >> imagesc(squeeze(S.VarArray(1).Data)
