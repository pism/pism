...
alltests = [
   ...
   ['C',[41,61,81,101,121],
        ...
        '(refinement path dx=50,33.33,25,20,16,km, dx=dy and Mx=My=41,61,81,101,121)'],
   ['D',[41,61,81,101,121],
        'isothermal SIA w variable accumulation',0,' -Mz 31 -y 25000.0',
        '(refinement path dx=50,33.33,25,20,16.67,km, dx=dy and Mx=My=41,61,81,101,121)'],
   ['A',[31,41,61,81,121],
        'isothermal SIA w marine margin',0,' -Mz 31 -y 25000.0',
        '(refinement path dx=53.33,40,26.67,20,13.33,km, dx=dy and Mx=My=31,41,61,81,121)'],
   ['E',[31,41,61,81,121],
   ...
   ['J',[30,60,120,180,240],'linearized, periodic ice shelf',0,
        ...
        '(refinement path dx=20,10,5,3.333,2.5, km; dx=dy and My=30,60,120,180,240)'],
   ['K',[41,81,161,321,641],
   ...
   ['L',[31,61,91,121,181],
        ...
        '(refinement path dx=60,30,20,15,10,km, dx=dy and Mx=My=31,61,91,121,181)'],
