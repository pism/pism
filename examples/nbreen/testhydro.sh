...
# -hydrology null
$MPIDO ${PATHTO}pismr -i start.nc -hydrology null $INPUTCHOICE -ys 0 -y $ENDTIME $EXTRASNULL -extra_file extras_null.nc  -o null.nc

# finer grid -hydrology null
#$MPIDO ${PATHTO}pismr -boot_file start.nc -Mx 241 -My 241 -Lz 4100 -Mz 201 -hydrology null $INPUTCHOICE -ys 0 -y $ENDTIME -extra_file extras_finenull.nc $EXTRASNULL -o finenull.nc
