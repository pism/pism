...
cmd="mpiexec -n $NN pismo -boot_file jako.nc -Mx $Mx -My $My -no_model_strip 10 -Lz 4000 -Lbz 1000 -Mz 201 -Mbz 51 -z_spacing equal -ocean_kill $CLIMATE -regrid_file $BCFILE -regrid_vars bmelt,bwat,enthalpy -y 1 -skip -skip_max 10 -o jako3km_y1.nc"
echo "running:   $cmd"
$cmd
echo
...
cmd="mpiexec -n $NN pismo -i jako3km_y1.nc \
  ...
  $CLIMATE -ys -$FINALSPIN -ye 0 -skip -skip_max 3 -o jako3km_0.nc"
echo "running:   $cmd"
$cmd
