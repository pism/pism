...
mpiexec -n $NN pgrn -bif eis_green_smoothed.nc -Mx 141 -My 83 -Lz 4000 -Mz 51 -quadZ \
...
mpiexec -n $NN pgrn -if green20km_y1.nc -no_mass -y 10000 -o green20km_Tsteady.nc
