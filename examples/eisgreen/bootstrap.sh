...
mpiexec -n $NN $PISM -boot_file eis_green_smoothed.nc -Mx 83 -My 141 -Lz 4000 -Mz 51 -Lbz 2000 -Mbz 21 -y 1 -o green20km_y1.nc
...
mpiexec -n $NN $PISM -i green20km_y1.nc -no_mass -y $NMSPINUP -o green20km_Tsteady.nc
