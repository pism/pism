...
parser = argparse.ArgumentParser(
    description="Preprocess for validation using constant flux experiment from Sayag & Worster (2013).  Creates PISM-readable bootstrap file and a configuration overrides file.",
...
dy = (2.0 * Ly) / float(My)
print(
    "  cells have dimensions dx = %.3f mm by dy = %.3f mm ..."
    % (dx * 1000.0, dy * 1000.0)
)
