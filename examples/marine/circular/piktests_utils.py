...
def process_options(default_filename, domain_size):
    ...
    parser.add_argument("-o", dest="output_filename", default=default_filename)
    parser.add_argument("-Mx", dest="Mx", type=int, default=301)
    parser.add_argument("-My", dest="My", type=int, default=301)
    parser.add_argument(
        "-domain_size", dest="domain_size", type=float, default=domain_size
    )
...
def prepare_output_file(nc, x, y, include_vel_bc=True):
    ...
    attrs = {
        "long_name": "mean annual temperature at ice surface",
        "units": "Kelvin",
        "_FillValue": 248.0,
    }
    ...
    ice_density = 910.0
    attrs = {
        "long_name": "mean annual net ice equivalent accumulation rate",
        "units": "kg m-2 year-1",
        "standard_name": "land_ice_surface_specific_mass_balance_flux",
        "_FillValue": 0.2 * ice_density,
    }  # 0.2 m/year
    ...
    attrs = {"long_name": "Dirichlet boundary condition locations", "units": "1"}
