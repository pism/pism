...
$doit -part_grid -o ws_part.nc $spatial_output ws_spatial_part.nc

# run with CFBC but no part_grid
# this could be a regression for the option "-cfbc"
$doit -cfbc -o ws_cfbc.nc $spatial_output ws_spatial_cfbc.nc
...
$doit -part_grid -cfbc -o ws_partcfbc.nc $spatial_output ws_spatial_partcfbc.nc
