...
pismopts="-boot_file $infile $grid -ssa_sliding -ssa_dirichlet_bc -ssa_view_nuh -view_map mask,thk -eigen_calving -eigen_calving_K 1e18 -thickness_calving -calving_at_thickness 300 -o_order zyx -ssafd_ksp_max_it 75 $pc_asm"
