...
if args.e == 'Stnd':
    print('extrastuff="-spatial_times 0:50:$duration -spatial_vars $listexvar"')
else:
    print('extrastuff="-spatial_times 0:1:$duration -spatial_vars $listexvar"')
...
print('')
print('opts="-config_override MISMIP3D_conf.nc $stressbalance $basal $calvingfront $subgl $modelopt -energy none -gradient eta -options_left -ts_file ts_%s.nc -ts_times 0:1:$duration -spatial_file ex_%s.nc $extrastuff -ys 0 -ye $duration -o_order zyx -o_size big -o %s.nc $STRONGKSP"' % (args.e, args.e, args.e))
