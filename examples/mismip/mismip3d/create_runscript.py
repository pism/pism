...
if args.e=='Stnd':
    ...
    print ''
    print '$pismr -boot_file MISMIP3D_stnd_initialSetup.nc -Mx $Mx -My 3 -Mz 15 -Lz 6000 $subgl -cold $modelopt -ssa_flow_law isothermal_glen -no_energy -ssa_sliding  -pseudo_plastic -gradient eta -pseudo_plastic_q 0.333333333 -tauc 1.0e7 -hold_tauc -pseudo_plastic_uthreshold 3.155693e+07 -calving ocean_kill -ocean_kill_file MISMIP3D_stnd_initialSetup.nc -config_override MISMIP3D_conf.nc -ssa_method fd -cfbc -part_grid -ssafd_ksp_rtol 1e-7 -ys 0 -ye $integration_time -options_left -extra_file ex_Stnd.nc -extra_times 0:50:$integration_time -extra_vars $listexvar -ts_file ts_Stnd.nc -ts_times 0:50:$integration_time -o Stnd.nc -o_order zyx -o_size big'
    ...
    print ''
    print '$pismr -boot_file MISMIP3D_P10S_initialSetup.nc -Mx $Mx -My $My -Mz 15 -Lz 6000 $subgl -cold $modelopt -ssa_flow_law isothermal_glen -no_energy -ssa_sliding  -pseudo_plastic -gradient eta -pseudo_plastic_q 0.333333333 -hold_tauc -pseudo_plastic_uthreshold 3.155693e+07 -calving ocean_kill -ocean_kill_file MISMIP3D_P10S_initialSetup.nc -config_override MISMIP3D_conf.nc -ssa_method fd -cfbc -part_grid -ssafd_ksp_rtol 1e-7 -ys 0 -ye $integration_time -options_left -stress_output -o P10S.nc -o_size big -o_order zyx -extra_file ex_P10S.nc -extra_times 0:1:$integration_time -extra_vars $listexvar -ts_file ts_P10S.nc -ts_times 0:1:$integration_time'

elif args.e=='P10R':
    print 'integration_time=100'
    print ''
    print '$pismr -i P10S.nc $subgl -cold $modelopt -ssa_flow_law isothermal_glen -no_energy -ssa_sliding  -pseudo_plastic -gradient eta -pseudo_plastic_q 0.333333333 -tauc 1.0e7 -hold_tauc -pseudo_plastic_uthreshold 3.155693e+07 -calving ocean_kill -ocean_kill_file P10S.nc -config_override MISMIP3D_conf.nc -ssa_method fd -cfbc -part_grid -ssafd_ksp_rtol 1e-7 -ys 0 -ye $integration_time -options_left -o_size big -o P10R.nc -o_order zyx -extra_file ex_P10R.nc -extra_times 0:1:$integration_time -stress_output -extra_vars $listexvar -ts_file ts_P10R.nc -ts_times 0:10:$integration_time'
    ...
    print '$python createSetup_PXXS.py -a $amplitude -i ex_Stnd.nc $s'
    print ''
    print '$pismr -boot_file MISMIP3D_P75S_initialSetup.nc -Mx $Mx -My $My -Mz 15 -Lz 6000 $subgl -cold $modelopt -ssa_flow_law isothermal_glen -no_energy -ssa_sliding  -pseudo_plastic -gradient eta -pseudo_plastic_q 0.333333333 -hold_tauc -pseudo_plastic_uthreshold 3.155693e+07 -calving ocean_kill -ocean_kill_file MISMIP3D_P75S_initialSetup.nc -config_override MISMIP3D_conf.nc -ssa_method fd -cfbc -part_grid -ssafd_ksp_rtol 1e-7 -ys 0 -ye $integration_time -options_left -stress_output -o P75S.nc -o_size big -o_order zyx -extra_file ex_P75S.nc -extra_times 0:1:$integration_time -extra_vars $listexvar -ts_file ts_P75S.nc -ts_times 0:1:$integration_time'

elif args.e=='P75R':
    print 'integration_time=100'
    print ''
    print '$pismr -i P75S.nc $subgl -cold $modelopt -ssa_flow_law isothermal_glen -no_energy -ssa_sliding  -pseudo_plastic -gradient eta -pseudo_plastic_q 0.333333333 -tauc 1.0e7 -hold_tauc -pseudo_plastic_uthreshold 3.155693e+07 -calving ocean_kill -ocean_kill_file P75S.nc -config_override MISMIP3D_conf.nc -ssa_method fd -cfbc -part_grid -ssafd_ksp_rtol 1e-7 -ys 0 -ye $integration_time -options_left -o_size big -o P10R.nc -o_order zyx -extra_file ex_P75R.nc -extra_times 0:1:$integration_time -stress_output -extra_vars $listexvar -ts_file ts_P75R.nc -ts_times 0:10:$integration_time'
