...
def config(step):
    ...
    attrs = {
        "stress_balance.ssa.fd.flow_line_mode": "true",
...
def pism_bootstrap_file(
    filename, step, v0, H0, calving_front=1750e3, N=None, p="default"
):
    import PISMNC
    ...
    nc.define_2d_field(
        ...
        attrs={"units": "", "long_name": "mask where -ocean_kill cuts off ice"},
    )
...
if __name__ == "__main__":
    ...
    print("Creating ICESHELF setup for step %s in %s..." % (opts.step, output_filename))
