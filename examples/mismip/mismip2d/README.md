...
Also, note that the variable `ice_area_glacierized_grounded` in `scalar_ABC1_1a_M1_A1.nc`
and similar allows one to see time-dependent changes in the grounding line location
because grounded ice area is proportional to the distance from the divide to the grounding
line.
