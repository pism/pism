...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "files", metavar="filename", type=str, nargs="+", help="files to process"
    )
    parser.add_argument(
        "-o", dest="output", type=str, nargs=1, help="output file name", required=True
    )
    parser.add_argument(
        "-p", dest="model_output", type=str, nargs=1, help="model state file"
    )
    parser.add_argument(
        "-f",
        dest="final",
