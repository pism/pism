...
m = Basemap(
    width=1.1 * width,  # width in projection coordinates, in meters
    ...
    lat_0=72,
)  # latitude of the plotting domain center
...
m.drawparallels(np.arange(-55.0, 90.0, 5.0), labels=[1, 0, 0, 0])
m.drawmeridians(np.arange(-120.0, 30.0, 10.0), labels=[0, 0, 0, 1])
