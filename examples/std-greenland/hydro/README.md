...
This run produces six files: `routing-decoupled.nc`, `ex_routing-decoupled.nc`,
`scalar_routing-decoupled.nc`, `distributed-decoupled.nc`, `ex_distributed-decoupled.nc`,
`scalar_distributed-decoupled.nc`.
...
To show some additional hydrology time-series do
    ...
    $ ./hydro-tsshow.py ts-routing.png scalar_routing-decoupled.nc
    $ ./hydro-tsshow.py ts-distributed.png scalar_distributed-decoupled.nc
