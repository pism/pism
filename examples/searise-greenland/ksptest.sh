...
echo
mpiexec -n 4 pismr -config_override searise_config.nc -acab_cumulative -skip -skip_max 10 -boot_file pism_Greenland_5km_v1.1.nc -Mx 76 -My 141 -Lz 4000 -Lbz 2000 -Mz 101 -Mbz 11 -z_spacing equal -ssa_sliding -thk_eff -topg_to_phi 5.0,20.0,-300.0,700.0 -bed_def lc -atmosphere searise_greenland,dTforcing -surface pdd -paleo_precip -dTforcing pism_dT.nc -ocean constant,dSLforcing -dSLforcing pism_dSL.nc -ocean_kill -regrid_file g20km_m5000a.nc -regrid_vars litho_temp,thk,enthalpy,bwat,bmelt -regrid_bed_special -y 10
...
echo
mpiexec -n 4 pismr -config_override searise_config.nc -acab_cumulative -skip -skip_max 10 -boot_file pism_Greenland_5km_v1.1.nc -Mx 76 -My 141 -Lz 4000 -Lbz 2000 -Mz 101 -Mbz 11 -z_spacing equal -ssa_sliding -thk_eff -topg_to_phi 5.0,20.0,-300.0,700.0 -bed_def lc -atmosphere searise_greenland,dTforcing -surface pdd -ocean_kill -regrid_file g20km_m5000a.nc -regrid_vars litho_temp,thk,enthalpy,bwat,bmelt -y 10
