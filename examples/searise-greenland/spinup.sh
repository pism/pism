...
COUPLER_FORCING="-atmosphere searise_greenland,forcing -surface pdd -pdd_fausto -paleo_precip -dTforcing $PISM_TEMPSERIES -ocean constant,forcing -dSLforcing $PISM_SLSERIES"
