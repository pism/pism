...
PISM="${PISM_PREFIX}${PISM_EXEC} -ocean_kill -e 3 -no_eta"
...
COUPLER_FORCING="-atmosphere searise_greenland,forcing -surface pdd -pdd_fausto -dTforcing $PISM_TEMPSERIES -ocean constant,forcing -dSLforcing $PISM_SLSERIES"
