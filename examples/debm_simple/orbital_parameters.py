...
if __name__ == "__main__":
    ...
    parser.description = (
        "Compute orbital parameters for use with PISM and '-surface debm_simple'"
    )
    parser.add_argument(
        "-o",
    ...
    parser.add_argument(
        "-p", "--plot", dest="plot", action="store_true", help="plot orbital parameters"
    )
    parser.add_argument(
        "-r",
        "--restrict_perihelion_longitude",
        dest="restrict",
        action="store_true",
